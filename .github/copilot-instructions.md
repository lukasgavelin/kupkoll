...
- [x] Scaffold the Project: Projektet bootstrapades manuellt i workspace-roten eftersom `.github` blockerade standardscaffold i samma katalog.
...
- Arbeta systematiskt vidare från denna status.
- Håll kommunikationen kort och fokuserad.
- Följ utvecklingsmässiga best practices.